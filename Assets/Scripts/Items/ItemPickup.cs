...
public class ItemPickup : MonoBehaviour
{
    ...
    [SerializeField] private bool dynamicPickup = true;
    ...
    public delegate void ItemPickupEventDelegate(ItemPickup itemPickup);
    public ItemPickupEventDelegate OnPickupDestroyed;
